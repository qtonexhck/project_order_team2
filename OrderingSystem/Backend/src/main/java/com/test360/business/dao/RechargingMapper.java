...
public interface RechargingMapper {
     ...
     * 根据条件查询记录集
     */
    List<Recharging> selectByExample(Criteria example);
     ...
     * 根据条件更新属性不为空的记录
     */
    int updateByExampleSelective(@Param("record") Recharging record, @Param("condition") Map<String, Object> condition);

    /**
     * 根据条件更新记录
     */
    int updateByExample(@Param("record") Recharging record, @Param("condition") Map<String, Object> condition);
